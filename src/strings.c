...
const u8 gText_50CoinsAndPrice[] = _("  100 COINS    ¥1,000");
const u8 gText_500CoinsAndPrice[] = _("1000 COINS  ¥10,000");
...
const u8 gText_Softboiled16BP[] = _("SOFTBOILED");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS");
const u8 gText_DreamEater24BP[] = _("DREAM EATER");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH");
const u8 gText_MegaKick48BP[] = _("MEGA KICK");
const u8 gText_BodySlam48BP[] = _("BODY SLAM");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE");
const u8 gText_Counter48BP[] = _("COUNTER");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL");
const u8 gText_Snore24BP[] = _("SNORE");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP");
const u8 gText_Swift24BP[] = _("SWIFT");
const u8 gText_IcyWind24BP[] = _("ICY WIND");
const u8 gText_Endure48BP[] = _("ENDURE");
const u8 gText_PsychUp48BP[] = _("PSYCH UP");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH");
const u8 gText_Nightmare[] = _("NIGHTMARE");
...
const u8 gText_Bonsly[] = _("Bonsly");
const u8 gText_MimeJr[] = _("Mime Jr.");
const u8 gText_Happiny[] = _("Happiny");
const u8 gText_Chingling[] = _("Chingling");
const u8 gText_Budew[] = _("Budew");
const u8 gText_Mantyke[] = _("Mantyke");
const u8 gText_VanillaTutors[] = _("Vanilla Moves");
const u8 gText_AdditionalTutors[] = _("Additional Moves");
const u8 gText_TrickHouseTutors[] = _("Trick House Moves");
